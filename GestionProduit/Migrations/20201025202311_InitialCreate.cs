        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SCategorie = table.Column<string>(nullable: true),
                    ...
                    NonFournisseur = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
             ...
             columns: table => new
             {
                 ...
                 LienFace = table.Column<string>(nullable: true),
                 Numtel = table.Column<int>(nullable: false),
                 Mail = table.Column<string>(nullable: true)
             },
             constraints: table =>
             {
                 table.PrimaryKey("PK_Fournnisseurs", x => x.FournisseurId);
             });
            migrationBuilder.CreateTable(
               name: "Categories",
               columns: table => new
            ...
            migrationBuilder.CreateTable(
              ...
              columns: table => new
              {
                  SCategIdId = table.Column<int>(nullable: false)
                      .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                  NomSCatego = table.Column<string>(nullable: true),
                 
                  CategorieId = table.Column<int>(nullable: false)
              },
              constraints: table =>
              {
                  table.PrimaryKey("PK_SCategories", x => x.SCategIdId);
                  table.ForeignKey(
                      name: "FK_SCategories_Categories_CategorieId",
